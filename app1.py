...
def main():
    ...
    unit_of_measure_per_pack = st.number_input("unit_of_measure_per_pack", value=0, step=1, format="%d")
    
    Line_Item_quantity = st.number_input("Line_Item_quantity", value=0, step=1, format="%d")
